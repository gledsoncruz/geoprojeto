...
class BairrosControllerTest < ActionController::TestCase
  ...
  test "should create bairro" do
    assert_difference('Bairro.count') do
      post :create, :bairro => { :nome => @bairro.nome, :popfem => @bairro.popfem, :popmasc => @bairro.popmasc, :the_geom => @bairro.the_geom }
    end
  ...
  test "should update bairro" do
    put :update, :id => @bairro, :bairro => { :nome => @bairro.nome, :popfem => @bairro.popfem, :popmasc => @bairro.popmasc, :the_geom => @bairro.the_geom }
    assert_redirected_to bairro_path(assigns(:bairro))
  end
